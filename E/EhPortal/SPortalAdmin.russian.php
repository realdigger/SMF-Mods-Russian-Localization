...
$txt['sp_delay_time'] = 'Время отображения новости';
$txt['sp_fade_time'] = 'Время затухания новости';
$txt['sp_bullets'] = 'Показывать маркеры у новостей';
...
$txt['sp_admin_pages_col_resize'] = 'Минимальная высота страницы';
...
<p>Перед тем, как пользователи смогут использовать чат, необходимо поместить его в блок, выбрав место его расположения.</p>
<p>Нажмите <a href="%s">здесь</a>, чтобы создать новый блок для этого чата.</p>
<p>Нажмите <a href="%s">здесь</a>, чтобы продолжить работу со списком мини-чатов.</p>';
...
$txt['sp-info_desc'] = 'Полезная системная информация и информация о EhPortal.';
$txt['sp-info_live'] = 'Актуальные новости от EhPortal...';
$txt['sp-info_no_live'] = 'Извините! Невозможно соединиться с web-develop.ca для получения последних файлов.';
...
$txt['sp-info_intro'] = 'Команда EhPortal выражает благодарность всем, кто использует и поддерживает EhPortal в его развитии, а также благодарит команду Simple Machines за их замечательный и стабильный движок форума SMF.';
...
$txt['sp-info_groups_dev'] = 'Разработчики SimplePortal';
$txt['sp-info_groups_webdev'] = 'Разработчики EhPortal';
...
$txt['sp-info_translators_message'] = 'Благодарим вас за ваши усилия по интернационализации EhPortal.';
$txt['sp-info_groups_founder'] = 'Отец-основатель EhPortal';
