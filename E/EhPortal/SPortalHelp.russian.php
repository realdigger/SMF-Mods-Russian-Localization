...
$helptxt['sp_portal_mode'] = 'Портал может отображаться В разных режимах:<br /><br />
<strong>Выключен:</strong> Полное отключение портала.<br /><br />
<strong>Главная страница:</strong> Эта опция отмечена по-умолчанию. Портал является главной страницей форума.<br /><br />
<strong>Интеграция:</strong> Эта опция отключит главную странцу портала. Блоки будут отображаться на форуме<br /><br />
...
$helptxt['sp_delay_time'] = 'Эта опция определяет время отображения в миллисекундах при ротации новостей.<br />0 - выключить ротацию.';
$helptxt['sp_fade_time'] = 'Эта опция определяет время затухания новости в миллисекундах при ротации новостей.';
$helptxt['sp_bullets'] = 'Эта опция включает маркеры для новостей.<br />Отключено, если время задержки ротации установлено в 0.';
...
<strong>forum:</strong> список разделов.<br />
<strong>sforum:</strong> во всех действиях и разделах, исключая портал.<br />
